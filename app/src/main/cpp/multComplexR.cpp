...
JNIEXPORT jdoubleArray JNICALL Java_com_example_windows10_androidndk_MainActivity_multComplexRealFromJNI(JNIEnv *env,
                                                                                                          jobject obj,jdoubleArray Real,jdoubleArray Imaginario) {
